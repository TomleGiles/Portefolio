...
PROJECTS = [
    {
        ...
        "fr": {"title": "SIOPS — plateforme Kubernetes de production",
               "tag": "Product Owner · équipe de 5 · portail GitOps Cassiopée", "desc": None},
        "en": {"title": "SIOPS — production Kubernetes platform",
               "tag": "Product Owner · team of 5 · Cassiopée GitOps portal", "desc": None},
    },
    {
        ...
        "fr": {"title": "ARCL — architecture hybride résiliente", "tag": "Azure × cloud privé", "desc": None},
        "en": {"title": "ARCL — resilient hybrid architecture", "tag": "Azure × private cloud", "desc": None},
    },
    {
        ...
        "fr": {"title": "CNP — Internal Developer Platform", "tag": "Repository-first", "desc": None},
        "en": {"title": "CNP — Internal Developer Platform", "tag": "Repository-first", "desc": None},
    },
    {
        ...
        "fr": {"title": "Ipsos — refonte du moteur d'export Excel",
               "tag": "Global BI · sept. 2025 – janv. 2026", "desc": None},
        "en": {"title": "Ipsos — rebuilding the Excel export engine",
               "tag": "Global BI · Sept 2025 – Jan 2026", "desc": None},
    },
    {
        ...
        "fr": {"title": "UBSI — leadership DevOps multi-équipes",
               "tag": "Pilotage du workstream DevOps · 50 participants", "desc": None},
        "en": {"title": "UBSI — multi-team DevOps leadership",
               "tag": "DevOps workstream lead · 50 participants", "desc": None},
    },
    {
        "slug": "danone", "cat": "consulting", "visual": None,
        "stack": ["SAP S/4HANA"],
        "chips": ["SAP S/4HANA", "Finance"],
        "fr": {"title": "Danone — architecture SAP S/4HANA Finance", "tag": "Architecture cible", "desc": None},
        "en": {"title": "Danone — SAP S/4HANA Finance architecture", "tag": "Target architecture", "desc": None},
    },
    {
        "slug": "beblood", "cat": "consulting", "visual": None,
        "stack": ["Oracle HCM", "Monte-Carlo"],
        "chips": ["Oracle HCM", "Monte-Carlo P80"],
        "fr": {"title": "BeBlood — transformation SIRH", "tag": "Oracle HCM · chiffrage Monte-Carlo", "desc": None},
        "en": {"title": "BeBlood — HRIS transformation", "tag": "Oracle HCM · Monte-Carlo estimation", "desc": None},
    },
    {
    ...
    },
    {
        ...
        "fr": {"title": "Lendr — casiers connectés vérifiés par IA", "tag": "Startup B2B cofondée", "desc": None},
        "en": {"title": "Lendr — smart lockers with AI checks", "tag": "Co-founded B2B startup", "desc": None},
    },
]
